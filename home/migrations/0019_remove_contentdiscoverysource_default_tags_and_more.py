...
def copy_default_tags_to_stream(apps, schema_editor):
    ContentDiscoverySource = apps.get_model("home", "ContentDiscoverySource")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0018_contentdiscoverysource_disable_tls_verification'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=wagtail.fields.StreamField([('tag', 0)], blank=True, block_lookup={0: ('wagtail.snippets.blocks.SnippetChooserBlock', ('home.GovukTag',), {'required': False})}, help_text='Optional tags to apply to discovered content from this source.'),
        ),
